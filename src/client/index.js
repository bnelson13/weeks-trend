import { articlesData } from './js/articles'
import { artsData } from './js/arts'
import { weeksData } from './js/weeks'
import { booksData } from './js/books'
import { classesData } from './js/classes'
import { funnysData } from './js/funnys'
import { gadgetsData } from './js/gadgets'
import { moviesData } from './js/movies'
import { picturesData } from './js/pictures'
import { podcastsData } from './js/podcasts'
import { recipesData } from './js/recipes'
import { songsData } from './js/songs'
import { toptensData } from './js/toptens'
import { triviasData } from './js/trivias'
import { tweetsData } from './js/tweets'
import { websitesData } from './js/websites'
...
const catButton = document.querySelector('#catDropMenuToggle');
catButton.addEventListener("click", function catDropMenuToggle () {
